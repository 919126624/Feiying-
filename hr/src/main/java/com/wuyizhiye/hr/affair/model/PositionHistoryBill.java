...
/**
 * 员工（组织、岗位、职级）异动单据model
 * @author ouyangyi
 * @since 2013-4-7 下午05:43:17
 */
public class PositionHistoryBill extends HrBillBase{
	...
	public String getChangeTypeName() {
		if(changeType!=null && !"".equals(changeType)){
			return PositionChangeTypeEnum.getEnumByValue(changeType).getLabel();
		}
	...
	public String getBillStatusName() {
		if(StringUtils.isNotNull(billStatus)){
			return BillStatusEnum.getEnumByValue(billStatus).getLabel();
		}
