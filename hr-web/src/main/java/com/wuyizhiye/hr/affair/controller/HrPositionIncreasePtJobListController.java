...
public class HrPositionIncreasePtJobListController extends ListController{
	...
	@RequestMapping(value="toPartTimeJobIndex")
	public String toPartTimeJobIndex(){
		return "hr/affair/partTimeJobIndex";
	}
	...
	protected String getListView() {
		...
		return "hr/positionincreaseptjob/positionIncreasePtJobList";
	}

	@Override
	protected String getEditView() {
		getRequest().setAttribute("isFilterByOrg", isFilterByOrg());
		return "hr/positionincreaseptjob/positionIncreasePtJobEdit";
	}
